...
class SignalStartEventTest extends EngineTestCase
{
     ...
     * @return array
     */
    public function createSignalStartWithPayloadProcesses()
    {
        $item = $this->repository->createItemDefinition([
            'id' => 'item',
            'isCollection' => true,
    ...
    /**
     * Tests signal with payloads
     */
    public function testSignalStartEventWithPayload() {
        //Create two processes
        list($processA, $processB) = $this->createSignalStartWithPayloadProcesses();
