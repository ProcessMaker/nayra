...
use ProcessMaker\Nayra\Bpmn\IntermediateTimerEventTrait;
 ...
 */
class IntermediateTimerEvent implements IntermediateTimerEventInterface
{
    use IntermediateTimerEventTrait,
        LocalFlowNodeTrait,
        LocalProcessTrait,
